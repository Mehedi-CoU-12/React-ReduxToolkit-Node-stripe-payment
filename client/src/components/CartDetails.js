...
import { addToCart,removeFromCart ,removeSingleIteams,emptycartIteam} from '../redux/features/cartSlice'
...
const CartDetails = () => {
    ...
    const makePayment=async()=>{
        ...
        const stripe=await loadStripe("pk_test_51P4IJGGrWz5ZEyO97vHAKmYBjIlZr0emMSZDEQaXRH1VA6XQKLjkcxuTRe4NIVMYjMTNzQ0pdRmA9SzhVEg4OKkZ00X0ITHIIk");
        ...
        await fetch("http://localhost:7000/api/create-checkout-session",{
            method:"POST",
            headers:headers,
                                    ...
                                    <table className='table cart-table mb-0 table-responsive-sm'>
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <th className='text-right '> <button className='btn btn-success' type='button' onClick={makePayment} >Chectout</button> </th>
                                            </tr>
                                        </tfoot>
                                    </table>
                                }
